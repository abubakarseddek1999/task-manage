...
export default function TaskBoard() {
    ...
    const fetchTasks = async () => {
        try {
            ...
            const response = await fetch(`https://task-manage-server-nine.vercel.app/tasks?email=${email}`);
    ...
    const createTask = async (columnId, taskData) => {
        try {
            ...
            const response = await fetch('https://task-manage-server-nine.vercel.app/tasks', {
                method: 'POST',
                headers: {
    ...
    const updateTaskInDb = async (taskId, updatedData) => {
        try {
            ...
            const response = await fetch(`https://task-manage-server-nine.vercel.app/task/${taskId}`, {
                method: 'PATCH',
                headers: {
                    'Content-Type': 'application/json'
                },
